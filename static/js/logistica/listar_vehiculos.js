...
$(function () {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="/configuracion/actualizar_vehiculo/' + row.id + '/" class="btn btn-success btn-xs btn-flat"><i class="fas fa-edit"></i></a> ';
    ...
    $('#data tbody')
        .on('click', 'a[rel="delete"]', function () {
            var tr = tblVeh.cell($(this).closest('td, li')).index();
            var data = tblVeh.row(tr.row).data();
