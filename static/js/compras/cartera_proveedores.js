...
$(function () {
    ...
    $('#data tbody')
        .on('click', 'a[rel="details"]', function () {
            ...
            $('input[name="ord"]').val(data.order_purchase.id);
            $('input[name="value"]').val('$ ' + data.order_purchase.total);
            $('input[name="date"]').val(data.order_purchase.order_date);
            $('input[name="subt"]').val('$ ' + data.order_purchase.subtotal);
            $('input[name="iva"]').val('$ ' + data.order_purchase.iva);
            $('input[name="desc"]').val('$ ' + data.order_purchase.dcto);
