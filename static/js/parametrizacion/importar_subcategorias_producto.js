...
$('#form').on('submit', function (e) {
    ...
    $.ajax({
        ...
        if (data.hasOwnProperty('success')){
            ...
            var jsnSubcategoriaProducto = data.jsnSubcategoriaProducto;
            var lstValidarImportacion = data.lstValidarImportacion;
            var parameters = new FormData();
            parameters.append('action', 'btnArchivoErroresjsn');
            parameters.append('jsnSubcategoriaProducto', jsnSubcategoriaProducto);
                ...
                $.confirm({
                    ...
                    buttons: {
                        Continuar: function () {
                            ...
                            a.href = url;
                            a.download = "errores_subcategorias_producto" + date_now + ".xlsx";
                            a.click();
